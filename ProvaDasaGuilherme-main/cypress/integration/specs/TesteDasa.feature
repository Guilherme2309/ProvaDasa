# language: pt
#Autor: Guilherme Luiz Vargas Do carmo
...
Esquema do Cenário: Consultar filme no serviço Search Movie
    Dado que eu realizo uma requisição para consultar um "<filme>"
    Então o filme sera validado quando pesquisado no SearchByMovie: "<filme>"
